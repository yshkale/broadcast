...
function BookmarksPage() {
  ...
  return (
    <div className="lg:mx-96 lg:max-w-4xl ">
      <div className="flex gap-8 px-6 py-2 items-center border-b border-stone-700 lg:border-x lg:border-stone-700 lg:py-6">
        <img
      ...
      {bookmarkedTweets.length === 0 && (
        <div className="flex justify-center items-center h-96">
          <p className="text-stone-500 text-sm px-8 text-center lg:text-md">
      ...
      {bookmarkedTweets.length >= 1 &&
        bookmarkedTweets.map((t) => {
          ...
          return (
            <div
              key={t.id}
              className="flex px-4 pt-4 pb-2 border-b border-stone-800 lg:py-8"
            >
              <Link
